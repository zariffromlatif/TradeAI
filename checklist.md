...
_Last reviewed: JWT marketplace authz hardening + dashboard fallback + data-health endpoint._
...
- [x] **F10** — Marketplace workflow (`Orders.jsx`, `/orders`) with RFQ board, quote submission/acceptance, deal settlement tracking, and role/ownership authorization
...
- [x] `node backend/scripts/verifyMarketplaceFlow.js` passes
- [x] `node backend/scripts/verifyMarketplaceGuards.js` passes
